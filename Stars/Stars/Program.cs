...
namespace Stars
{
        ...
        private float Random(object p1, object p2)
        {
            throw new NotImplementedException();
        }
        ...
        private void line(float px, float py, float sx, float sy)
        {
            throw new NotImplementedException();
        }

        private void stroke(int v)
        {
            throw new NotImplementedException();
        }

        private void ellipse(float sx, float sy, float r1, float r2)
        {
            throw new NotImplementedException();
        }

        private float map(float v1, int v2, int v3, int v4, int v5)
        {
            throw new NotImplementedException();
        }
